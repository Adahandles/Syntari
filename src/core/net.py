...
def http_post(url: str, data: Union[Dict[str, Any], str], 
...
def http_put(url: str, data: Union[Dict[str, Any], str], 
             headers: Optional[Dict[str, str]] = None, 
             timeout: int = 30) -> HTTPResponse:
    """
...
def http_delete(url: str, headers: Optional[Dict[str, str]] = None, 
                timeout: int = 30) -> HTTPResponse:
    """
